...
INSERT INTO task (name, is_complete, file_url, deadline, project_id, user_id) VALUES
    ...
    ('Выполнить тестовое задание', 0, 'home.psd', '2022-06-13 16:00:00', 3, 1),
    ('Сделать задание первого раздела', 1, 'home.psd', '2022-06-10 16:00:00', 2, 2),
    ('Встреча с другом', 0, '', '2022-06-10 16:00:00', 1, 2),
    ('Купить корм для кота', 0, '', '2022-06-10 16:00:00', 4, 2),
